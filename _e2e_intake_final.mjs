...
async function main() {
  ...
  console.log("Review page mentions reference AQTIV-PO-E2E-002:", bodyText.includes("AQTIV-PO-E2E-002"));
  ...
  console.log("Body after submit:", (await page.locator('body').innerText()).slice(0, 400));
