...
const MOCK_NOTIFICATIONS: NotificationLog[] = [
  {
    ...
    subject: "New Application Received: Levi Strauss Co. (APP-2026-0881)",
    body: "Levi Strauss Co. submitted a new order application for 457 units of 1947 501XX Selvedge.",
