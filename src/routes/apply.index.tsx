    ...
    <ApplyLayout title="Client Self-Service Intake Portal">
      <div className="max-w-5xl mx-auto px-4 py-12 md:py-20 space-y-16">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-50 text-amber-900 border border-amber-200 text-xs font-bold shadow-2xs">
            <Factory className="w-3.5 h-3.5 text-amber-700" />
            <span>Forge &amp; Fabric — Client Intake &amp; Order Portal</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-3xl p-8 border-2 border-amber-500 shadow-md hover:shadow-xl hover:border-amber-600 transition-all flex flex-col justify-between group">
            <div className="space-y-4">
              <div className="h-14 w-14 rounded-2xl bg-amber-700 text-white flex items-center justify-center shadow-md group-hover:scale-105 transition-transform">
              ...
              <ul className="space-y-2 text-xs text-neutral-600 pt-2">
            ...
            <div className="pt-8">
              <Link
                to="/apply/new"
                className="w-full h-12 rounded-xl bg-amber-700 hover:bg-amber-800 text-white font-bold text-xs shadow-md flex items-center justify-center gap-2 transition-all cursor-pointer active:scale-98"
              >
          ...
          {/* Card 2: Track Status */}
          <div className="bg-white rounded-3xl p-8 border border-neutral-200 shadow-xs hover:shadow-lg hover:border-neutral-400 transition-all flex flex-col justify-between group">
            <div className="space-y-4">
              <div className="h-14 w-14 rounded-2xl bg-neutral-900 text-white flex items-center justify-center shadow-md group-hover:scale-105 transition-transform">
            ...
            <div className="pt-8">
              <Link
                ...
                className="w-full h-12 rounded-xl bg-neutral-900 hover:bg-neutral-800 text-white font-bold text-xs shadow-xs flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
          ...
          <div className="bg-white rounded-3xl p-8 border border-neutral-200 shadow-xs hover:shadow-lg hover:border-neutral-400 transition-all flex flex-col justify-between group">
            <div className="space-y-4">
              <div className="h-14 w-14 rounded-2xl bg-amber-50 border border-amber-200 text-amber-800 flex items-center justify-center shadow-2xs group-hover:scale-105 transition-transform">
            ...
            <div className="pt-8">
              <Link
                to="/apply/update"
                className="w-full h-12 rounded-xl bg-white border border-neutral-300 hover:bg-neutral-50 text-neutral-800 font-bold text-xs shadow-2xs flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
        ...
        {/* Factory Standards & Guarantees (Clean White / Slate card) */}
