...
async function checkSampleTypeEnum() {
  // Let's check columns and types of sample_requests
  const { data, error } = await supabase.rpc("get_schema_info"); // or try selecting from sample_requests
